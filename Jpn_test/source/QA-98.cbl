      ******************************************************************
      *    ÉeÉXÉgÉPÅ[ÉXÅFQA98
      *    ÉvÉçÉOÉâÉÄñºÅFì˙ñ{åÍâªÉeÉXÉg ÅiìYÇ¶éöéQè∆Åj
      *    èàóùäTóvÅ@Å@ÅFìYÇ¶éöéQè∆Ç™ê≥ÇµÇ≠é¿çsÇ≥ÇÍÇÈÇ©ÇÉ`ÉFÉbÉNÇ∑ÇÈÅB
      *  --------------------------------------------------------------
      *   ÉeÉXÉgÉPÅ[ÉX:ÇPÅ`ÇV
      ******************************************************************
      ...
      ******************************************************************
       ...
       01  GRP-01.
           05  GRP-01-DEF.
               ...
               10  FILLER    PIC X(10) VALUE "Ç†Ç¢Ç§Ç¶Ç®".
               10  FILLER    PIC X(10) VALUE "Ç©Ç´Ç≠ÇØÇ±".
               10  FILLER    PIC X(10) VALUE "Ç`ÇaÇbÇcÇd".
               10  FILLER    PIC X(10) VALUE "ÇeÇfÇgÇhÇi".
      ...
      *
            ...
            MOVE 2 to WK-I.
            IF GRP-01-N4(WK-I) = 
               "Ç†Ç¢Ç§Ç¶Ç®Ç©Ç´Ç≠ÇØÇ±Ç`ÇaÇbÇcÇdÇeÇfÇgÇhÇi"
                                DISPLAY CASE-ID "OK"
