      ...
      *      IF GE-09(1:16382) = ALL "ÇOÇPÇQÇRÇSÇTÇUÇVÇWÇX" AND
      *         GE-09(16383:1) = "Å^"
      ...
      *
            ...
            MOVE ALL "ÇOÇPÇQÇRÇSÇTÇUÇVÇWÇX" TO G-99.
            MOVE FUNCTION BYTE-LENGTH(G-99) TO W-L.
            IF G-99 = ALL "ÇOÇPÇQÇRÇSÇTÇUÇVÇWÇX"
               AND W-L = 32768
                                        DISPLAY CASE-ID "OK"
               ELSE                     DISPLAY CASE-ID "NG"  W-L
            END-IF.
      ...
      *      MOVE ALL "ÇOÇPÇQÇRÇSÇTÇUÇVÇWÇX" TO GE-99.
