      ...
      ******************************************************************
       MAIN                  SECTION.
       P-010. 
            DISPLAY "TEST START (EX6-1)".
      *ケース1.基本データ項目
            MOVE "P-010-01"        TO CASE-ID.
            MOVE FUNCTION LENGTH(X-01)     TO W-LENG.
            IF W-LENG = 10           DISPLAY CASE-ID "OK"
               ELSE                  DISPLAY CASE-ID "NG:W-LENG=" W-LENG
            END-IF.
      *
            MOVE "P-010-02"        TO CASE-ID.
            MOVE FUNCTION LENGTH(A-01)     TO W-LENG.
            IF W-LENG = 5            DISPLAY CASE-ID "OK"
               ELSE                  DISPLAY CASE-ID "NG:W-LENG=" W-LENG
            END-IF.
      *
            MOVE "P-010-03"        TO CASE-ID.
            MOVE FUNCTION LENGTH(ZONE-01)     TO W-LENG.
            IF W-LENG = 3            DISPLAY CASE-ID "OK"
               ELSE                  DISPLAY CASE-ID "NG:W-LENG=" W-LENG
            END-IF.
      *
            MOVE "P-010-04"        TO CASE-ID.
            MOVE FUNCTION LENGTH(PACK-01)     TO W-LENG.
            IF W-LENG = 4            DISPLAY CASE-ID "OK"
               ELSE                  DISPLAY CASE-ID "NG:W-LENG=" W-LENG
            END-IF.
      *
            MOVE "P-010-05"        TO CASE-ID.
            MOVE FUNCTION LENGTH(BIN-01)     TO W-LENG.
            IF W-LENG = 4            DISPLAY CASE-ID "OK"
               ELSE                  DISPLAY CASE-ID "NG:W-LENG=" W-LENG
            END-IF.
      *
            MOVE "P-010-06"        TO CASE-ID.
            MOVE FUNCTION LENGTH(G-01)     TO W-LENG.
            IF W-LENG = 8            DISPLAY CASE-ID "OK"
               ELSE                  DISPLAY CASE-ID "NG:W-LENG=" W-LENG
            END-IF.
      *
            MOVE "P-010-07"        TO CASE-ID.
            MOVE FUNCTION LENGTH(GE-01)     TO W-LENG.
            IF W-LENG = 7            DISPLAY CASE-ID "OK"
               ELSE                  DISPLAY CASE-ID "NG:W-LENG=" W-LENG
            END-IF.

      *ケース2：定数
            MOVE "P-020-01"        TO CASE-ID.
            MOVE FUNCTION LENGTH("ABC")     TO W-LENG.
            IF W-LENG = 3            DISPLAY CASE-ID "OK"
               ELSE                  DISPLAY CASE-ID "NG:W-LENG=" W-LENG
            END-IF.
      *
            MOVE "P-020-02"        TO CASE-ID.
            MOVE FUNCTION LENGTH("あいうえお")     TO W-LENG.
            IF W-LENG = 5            DISPLAY CASE-ID "OK"
               ELSE                  DISPLAY CASE-ID "NG:W-LENG=" W-LENG
            END-IF.
      *
            MOVE "P-020-03"        TO CASE-ID.
            MOVE FUNCTION LENGTH("あいうXYお")     TO W-LENG.
            IF W-LENG = 10           DISPLAY CASE-ID "OK"
               ELSE                  DISPLAY CASE-ID "NG:W-LENG=" W-LENG
            END-IF.
      *
            MOVE "P-020-04"        TO CASE-ID.
            MOVE FUNCTION LENGTH(12345)     TO W-LENG.
            IF W-LENG = 5            DISPLAY CASE-ID "OK"
               ELSE                  DISPLAY CASE-ID "NG:W-LENG=" W-LENG
            END-IF.
      *
            MOVE "P-020-05"        TO CASE-ID.
            MOVE FUNCTION LENGTH(X"01020304")     TO W-LENG.
            IF W-LENG = 4            DISPLAY CASE-ID "OK"
               ELSE                  DISPLAY CASE-ID "NG:W-LENG=" W-LENG
            END-IF.
      *
            MOVE "P-020-06"        TO CASE-ID.
            MOVE FUNCTION LENGTH("ABC" & "あいう")     TO W-LENG.
      ...
      *ケース6：SYNC
            ...
            MOVE FUNCTION LENGTH(GRP-04) TO W-LENG.
            IF W-LENG = 20           DISPLAY CASE-ID "OK"
               ELSE                  DISPLAY CASE-ID "NG:W-LENG=" W-LENG
            END-IF.
      *
            MOVE "P-060-02"        TO CASE-ID.
            MOVE FUNCTION LENGTH(GRP-05) TO W-LENG.
