      ...
      * 
            ...
            INSPECT G-01 REPLACING ALL SPACES BY "Å|"
                AFTER "Å{".
      *      
            IF G-01 = "Ç`ÇaÅ{ÇbÅ|ÇcÅ|ÇdÅ|Å|"
                  DISPLAY CASE-ID "OK"
      ...
      * 
            ...
            MOVE "AB+C D E"       TO G-01.
            INSPECT G-01 REPLACING ALL "Å@" BY "Å|"
                AFTER "Å{".
      *      
            IF G-01 = "Ç`ÇaÅ{ÇbÅ|ÇcÅ|ÇdÅ|Å|"
                  DISPLAY CASE-ID "OK"
      ...
      * 
            ...
            INSPECT G-01 REPLACING ALL ZERO BY "Å|"
                AFTER "Å{".
      *      
            IF G-01 = "Ç`ÇaÅ{ÇbÅ|ÇcÅ|ÇdÅ@Å@"
                  DISPLAY CASE-ID "OK"
      ...
      * 
            ...
            MOVE "AB+C0D0E"       TO G-01.
            INSPECT G-01 REPLACING ALL "ÇO" BY "Å|"
                AFTER "Å{".
      *      
            IF G-01 = "Ç`ÇaÅ{ÇbÅ|ÇcÅ|ÇdÅ@Å@"
                  DISPLAY CASE-ID "OK"
