      ...
      *  --------------------------------------------------------------
      *   テストケース:CURRENCY SIGN句に「#」を指定すると「\」「$」も使えない。
      ******************************************************************
      ...
      *
       01  NEDIT-01X.
           *>05 NEDIT-01   PIC $$$,$$9.
           05 NEDIT-01   PIC ###,##9.  *>20210501 #2Only 1 CS is acceptable
       01  NEDIT-02X.
           *>05  NEDIT-02  PIC \\\,\\9. *>20210501 #2Only 1 CS is acceptable
           05  NEDIT-02  PIC ###,##9.
       01  WK-I          PIC S9(3).
      ******************************************************************
       PROCEDURE             DIVISION.
